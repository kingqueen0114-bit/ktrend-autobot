...
from src.sanity_client import SanityClient
...
def get_articles_needing_meta(sanity: SanityClient) -> list:
...
def batch_update(sanity: SanityClient, updates: list[dict]):
...
def main():
    ...
    articles = get_articles_needing_meta(sanity)
